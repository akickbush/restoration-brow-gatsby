      ...
      <div className="container-fluid">
        <Accordion>
          <AccordionItem
            ...
            content={[
              `A 48 hour notice is required to cancel or reschedule a brow appointment. If unable to do so the deposit will be non-refundable or non-transferable.`,
            ]}
          />
          <AccordionItem
          ...
          <AccordionItem
            ...
            content={[
              `Pregnant/breast-feeding. currently using Accutane or have used Accutane within the past year. Have a freshly hand/sunburn face. on blood thinning medications or antibiotics. Have rosacea. Are currently undergoing cancer treatment. must be off chemo or radiation for six months.`,
            ]}
          />
          <AccordionItem
            title={`How do I prepare for my procedure.?`}
            content={[
              `If you have reference pictures please feel free to bring these to your appointment. Along with the pencil or powder you are currently using. If you tint your brows you will want to do so 72 hours before your appointment. You must not use Retin-A near the brow area two weeks before or two weeks after the procedure. You will need to avoid water for 7 to 10 days after. This includes excessive sweating, pool, lakes, salt water, and extreme sun exposure, So plan your vacations accordingly. No Botox, fillers, Microdermabrasion, chemical peels or anything of the like for at least two weeks prior to your procedure, and also two weeks after.`,
            ]}
          />
          <AccordionItem
            title={`Avoid doing these before your procedure:`}
            content={[
              `Doing any of the following prior to your appointment could alter the outcome of your cosmetic tattoo. Do you not work out the day of your appointment. You should not take any medication that may thin your blood (i.e. aspirin, ibuprofen.)72 hours before or immediately after your procedure. Do not drink alcohol within 24 hours of your procedure. Avoid caffeine for 12 hours before your procedure, caffeine increases blood flow in will affect your healed result.`,
            ]}
          />
          <AccordionItem
            title={`How long does my appointment take?`}
            content={[
              `Your appointment can take up to two and a half hours. This allows plenty of time to discuss your procedure and Draw your eyebrows on with satisfaction and symmetry. This allows me as much time as I need to prefect your eyebrows and discuss aftercare with you.`,
            ]}
          />
          <AccordionItem
          ...
          <AccordionItem
            ...
            content={[
              `Yes! All Permanent Cosmetic procedures require 2 sessions. During your 4-8 week follow-up we can assess your pigment retention and make any adjustments needed. This follow-up also increases the longevity of your Cosmetic tattoo.`,
            ]}
          />
          <AccordionItem
